...
public class TicTacToeDemo {
	...
	public static void main(String[] args) {
		...
		board1.displayBoard();
		if (board1.getWinner()!= board1.getEmptySpace()) {
		...
		board2.displayBoard();
		if (board2.getWinner()!= board2.getEmptySpace()) {
			System.out.println(board2.getWinner()+ " won!");
		};
		
		TicTacToeBoard board3 = new TicTacToeBoard(4);
		...
		board3.displayBoard();
		if (board3.getWinner()!= board3.getEmptySpace()) {
		...
		board4.displayBoard();
		if (board4.getWinner()!= board4.getEmptySpace()) {
